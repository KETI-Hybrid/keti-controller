...
//+kubebuilder:rbac:groups=level.keti.res,resources=rebalances,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=level.keti.res,resources=rebalances/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=level.keti.res,resources=rebalances/finalizers,verbs=update

...
//+kubebuilder:rbac:groups=level.hybrid.keti,resources=rebalances,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=level.hybrid.keti,resources=rebalances/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=level.hybrid.keti,resources=rebalances/finalizers,verbs=update

...
//+kubebuilder:rbac:groups=cloud.hybrid.keti,resources=nhns,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=cloud.hybrid.keti,resources=nhns/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=cloud.hybrid.keti,resources=nhns/finalizers,verbs=update
